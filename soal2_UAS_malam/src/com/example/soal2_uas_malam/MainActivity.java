	...
	@Override
		 ...
		 sim.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				postparameter.add(new
				BasicNameValuePair("email",email.getText().toString()));
				postparameter.add(new
				BasicNameValuePair("hp",hp.getText().toString()));
				String respon=null;
				
				try{
					respon=CustomHttpClient.executeHttpPost("http://10.0.2.2/koneksi-soaluas2.php",postparameter);
